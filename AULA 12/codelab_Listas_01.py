...
for c in range(7):
    num = int(input(f'Digite o {c}º número: ')) #valor digitado vai para 
    if num % 2 ==0:
        lista[0].append(num) # todo numero divisivel por 2 vai para o indice 0 da lista principal, dentro outra lista
    else:
        lista[1].append(num) # os que a dividao por 2 nao for exata, vao para indice 1 da lista princ, dentro da lista
